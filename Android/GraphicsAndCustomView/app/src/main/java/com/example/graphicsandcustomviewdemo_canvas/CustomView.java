...
public class CustomView extends View {
    ...
    protected void onDraw(Canvas canvas){
        ...
        canvas.drawOval(new RectF(160,60,550,80),paint);

        //draw text
        textPaint.setTextSize(22);
        canvas.drawText("Hi Ramesh How Are You?",20,150, textPaint);
        textPaint.setColor(Color.MAGENTA);
        textPaint.setTextSize(40);
        canvas.drawText("Ramesh in different color", 20, 190, textPaint);

        //transparency
        textPaint.setColor(0xFF465574);
        textPaint.setTextSize(60);
        canvas.drawText("Transparent Text", 20, 340, textPaint);
